        ...
        <div class="min-h-screen flex fle-col items-center justify-center">
            <div class="py-6 px-4">
                ...
                <form class="space-y-6" action="{{ url('/profile') }}" method="get">
                    <div class="mb-12">
                        <h1 class="text-white text-3xl font-semibold">Registrar-se</h1>
                        <p class="text-gray-400 text-[15px] mt-6 leading-relaxed">Crie sua conta e explore o mundo do Papa Platinas!</p>
                    </div>

                    <div>
                        <label class="text-white text-sm font-medium mb-2 block">Email</label>
                        <div class="relative flex items-center">
                        <input name="email" type="text" required class="w-full text-sm text-slate-900 border border-slate-300 pl-4 pr-10 py-3 outline-blue-600" placeholder="Informe seu email" />
                        </div>
                    </div>
                    <div>
                        <label class="text-white text-sm font-medium mb-2 block">Usuário</label>
                        <div class="relative flex items-center">
                        <input name="username" type="text" required class="w-full text-sm text-slate-900 border border-slate-300 pl-4 pr-10 py-3 outline-blue-600" placeholder="Defina seu nome de usuário" />
                    ...
                    <div>
                        ...
                        <div class="relative flex items-center">
                        <input name="password" type="password" required class="w-full text-sm text-slate-900 border border-slate-300 pl-4 pr-10 py-3 outline-blue-600" placeholder="Defina sua senha" />
                    ...
                    <div>
                        <label class="text-white text-sm font-medium mb-2 block">Senha</label>
                        <div class="relative flex items-center">
                        <input name="password" type="password" required class="w-full text-sm text-slate-900 border border-slate-300 pl-4 pr-10 py-3 outline-blue-600" placeholder="Insira sua senha novamente" />
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" class="w-[18px] h-[18px] absolute right-4 cursor-pointer" viewBox="0 0 128 128">
                            <path d="M64 104C22.127 104 1.367 67.496.504 65.943a4 4 0 0 1 0-3.887C1.367 60.504 22.127 24 64 24s62.633 36.504 63.496 38.057a4 4 0 0 1 0 3.887C126.633 67.496 105.873 104 64 104zM8.707 63.994C13.465 71.205 32.146 96 64 96c31.955 0 50.553-24.775 55.293-31.994C114.535 56.795 95.854 32 64 32 32.045 32 13.447 56.775 8.707 63.994zM64 88c-13.234 0-24-10.766-24-24s10.766-24 24-24 24 10.766 24 24-10.766 24-24 24zm0-40c-8.822 0-16 7.178-16 16s7.178 16 16 16 16-7.178 16-16-7.178-16-16-16z" data-original="#000000"></path>
                        </svg>
                        </div>
                    ...
                    <div class="!mt-12">
                        ...
                        <p class="text-sm !mt-6 text-center text-slate-600">Já tem uma conta? <a href="{{ url("/login") }}" class="text-blue-600 font-medium hover:underline ml-1 whitespace-nowrap">Logue agora</a></p>
                    </div>
                </form>
                </div>
